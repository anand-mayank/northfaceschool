...
<html lang="zxx">
<head>
<title>THE NORTH FACE PUBLIC SCHOOL, GAYA</title>
<!-- Meta tag Keywords -->
<meta name="viewport" content="width=device-width, initial-scale=1">
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<meta name="keywords" content="THE NORTH FACE PUBLIC SCHOOL, GAYA" />
...
<div class="main_section_agile" id="home">
	<div class="agileits_w3layouts_banner_nav">
		<nav class="navbar navbar-default">
			...
			<h1><a class="navbar-brand" href="index.html"><i class="fa fa-leanpub" aria-hidden="true"></i> The North Face Public School</a></h1>
			...
			<div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">
				<nav class="link-effect-2" id="link-effect-2">
					<ul class="nav navbar-nav">
						...
						<li><a href="#team" class="effect-3 scroll">Teachers</a></li>
	...
	<div class="col-md-6 w3l_about_bottom_right one">
		<div class="abt-w3l">
			<div class="header-w3l" >
				...
				<form action="mailto:thenorthfacepublicschool@gmail.com" method="post" class="mod2" enctype="text/plain">
					<div class="col-md-6 col-xs-6 w3l-left-mk">
						<ul>
							...
							<li class="agileits-main"><i class="fa fa-user-o" aria-hidden="true"></i><input name="F.Name" type="text" required=""></li>
					...
					<div class="col-md-6 col-xs-6 w3l-right-mk">
						<ul>
							...
							<li class="agileits-main"><i class="fa fa-map-marker" aria-hidden="true"></i><input name="address" type="text" ></li>
						</ul>
					</div>
					<div class="clearfix"></div>
					<div class="agile-submit">
						<input type="submit" value="Mail Us">
					</div>
				</form>
			</div>
		</div>
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<div class="modal-body">
				<img src="images/ab2.jpeg" alt=""> 
				<p><b> The North Face Public School is a complete school for children.</b> </p>
			</div> 
		</div>
	</div>
</div>
	...
	<div class="container">
		<div class="stats-info">
			<div class="col-md-3 col-xs-3 stats-grid slideanim">
				...
				<h4 class="stats-info">PAGE VISIT</h4>
			</div>
			<div class="col-md-3 col-xs-3 stats-grid slideanim">
				<i class="fa fa-book" aria-hidden="true"></i>
				<div class='numscroller numscroller-big-bottom' data-slno='1' data-min='0' data-max='100' data-delay='.5' data-increment="1">31000</div>
				
				<h4 class="stats-info">CLASSES COMPLETE</h4>
			</div>
			<div class="col-md-3 col-xs-3 stats-grid slideanim">
				<i class="fa fa-trophy" aria-hidden="true"></i>
				<div class='numscroller numscroller-big-bottom' data-slno='1' data-min='0' data-max='100' data-delay='.5' data-increment="10">79000</div>
				
				<h4 class="stats-info">STUDENTS ENROLLED</h4>
			</div>
			<div class="col-md-3 col-xs-3 stats-grid slideanim">
					<i class="fa fa-user" aria-hidden="true"></i>
				<div class='numscroller numscroller-big-bottom' data-slno='1' data-min='0' data-max='100' data-delay='.5' data-increment="1">600</div>
			...
			<p><i class="fa fa-graduation-cap" aria-hidden="true"></i></p>
				...
				<div class="col-md-3 col-xs-3 gallery-grid gallery1">
					<a href="images/g1.jpg" class="swipebox"><img src="images/g1.jpg" class="img-responsive" alt="/">
						<div class="textbox">
						<h4>Click for Zoom</h4>
							<p><i class="fa fa-picture-o" aria-hidden="true"></i></p>
						</div>
				</a>
				</div>
				<div class="col-md-3 col-xs-3 gallery-grid gallery1">
					<a href="images/g2.jpg" class="swipebox"><img src="images/g2.jpeg" class="img-responsive" alt="/">
						<div class="textbox">
						<h4>Click for Zoom</h4>
							<p><i class="fa fa-picture-o" aria-hidden="true"></i></p>
						</div>
				...
				<div class="col-md-3 col-xs-3 gallery-grid gallery1">
					<a href="images/g3.jpg" class="swipebox"><img src="images/g3.jpeg" class="img-responsive" alt="/">
						<div class="textbox">
						<h4>Click for Zoom</h4>
							<p><i class="fa fa-picture-o" aria-hidden="true"></i></p>
						</div>
				...
				<div class="col-md-3 col-xs-3 gallery-grid gallery1">
					<a href="images/g7.jpg" class="swipebox"><img src="images/g7.jpeg" class="img-responsive" alt="/">
						<div class="textbox">
						<h4>Click for Zoom</h4>
							<p><i class="fa fa-picture-o" aria-hidden="true"></i></p>
						</div>
				...
				<div class="col-md-3 col-xs-3 gallery-grid gallery1">
					<a href="images/g5.jpg" class="swipebox"><img src="images/g5.jpeg" class="img-responsive" alt="/">
						<div class="textbox">
						<h4>Click for Zoom</h4>
							<p><i class="fa fa-picture-o" aria-hidden="true"></i></p>
						</div>
				...
				<div class="col-md-3 col-xs-3 gallery-grid gallery1">
					<a href="images/g11.jpg" class="swipebox"><img src="images/g11.jpeg" class="img-responsive" alt="/">
						<div class="textbox">
						<h4>Click for Zoom</h4>
							<p><i class="fa fa-picture-o" aria-hidden="true"></i></p>
					   </div>
				...
				<div class="col-md-3 col-xs-3 gallery-grid gallery1">
					...
					<div class="col-md-3 col-xs-3 gallery-grid gallery1">
					<a href="images/g9.jpg" class="swipebox"><img src="images/g9.jpeg" class="img-responsive" alt="/">
						<div class="textbox">
						<h4>Click for Zoom</h4>
							<p><i class="fa fa-picture-o" aria-hidden="true"></i></p>
						</div>
				...
				<div class="col-md-3 col-xs-3 gallery-grid gallery1">
					<a href="images/g10.jpg" class="swipebox"><img src="images/g10.jpeg" class="img-responsive" alt="/">
						<div class="textbox">
						<h4>Click for Zoom</h4>
							<p><i class="fa fa-picture-o" aria-hidden="true"></i></p>
						</div>
				...
				<div class="col-md-3 col-xs-3 gallery-grid gallery1">
					<a href="images/g4.jpg" class="swipebox"><img src="images/g4.jpeg" class="img-responsive" alt="/">
						<div class="textbox">
						<h4>Click for Zoom</h4>
							<p><i class="fa fa-picture-o" aria-hidden="true"></i></p>
						</div>
				...
				<div class="col-md-3 col-xs-3 gallery-grid gallery1">
					<a href="images/g12.jpg" class="swipebox"><img src="images/g12.jpeg" class="img-responsive" alt="/">
						<div class="textbox">
						<h4>Click for Zoom</h4>
							<p><i class="fa fa-picture-o" aria-hidden="true"></i></p>
						</div>
...
<div class="team-w3l" id="team">
	<div class="container">
		<h3 class="w3l-title">Our Teachers</h3>
		<div class="w3layouts_header">
			<p><i class="fa fa-graduation-cap" aria-hidden="true"></i></p>
		</div>
				...
				<div class="about_img"><img src="images/t1.jpg" alt="">
				  ...
				  <div class="about_opa">
					...
					<ul class="fb_icons2 text-center">
						<li><a class="fa fa-facebook" href="https://www.facebook.com/arvind.sinha.5680" target="_blank"></a></li>
		...
		<div class="agile_banner_bottom_grids">
			...
			<div class="col-md-4 col-xs-4 w3_agile_contact_grid">
				...
				<div class="agile_contact_grid_right agileits_w3layouts_right">
					<h4>Phone</h4>
					<p>+91 943 140 9346 <span>+91 943 140 9346</span></p>
				</div>
			</div>
			<div class="col-md-4 col-xs-4 w3_agile_contact_grid">
				...
				<div class="agile_contact_grid_right agileits_w3layouts_right1">
					<h4>Email</h4>
					<p><a href="mailto:thenorthfacepublicschool@gmail.com">thenorthfacepublicschool@gmail.com</a>
						<span><a href="mailto:arvindkr.sinha163@gmail.com">arvindkr.sinha163@gmail.com</a></span></p>
				</div>
				<div class="clearfix"> </div>
			</div>
			<div class="clearfix"> </div>
		...
		<div class="w3l-form">
			...
			<div class="contact-grid1">
				<div class="contact-top1">
					<form action="mailto:thenorthfacepublicschool@gmail.com" method="post">
				...
				<br>
					<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3621.576999012063!2d85.00210751435993!3d24.80993405339234!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x39f32b133ca09a1d%3A0xdf2d45b5cc2eae81!2sNorth%20Face%20public%20school!5e0!3m2!1sen!2sin!4v1580497260509!5m2!1sen!2sin" width="100%" height="600" frameborder="0" style="border:0;" allowfullscreen=""></iframe>
							</br>
				</div>
			</div>
		</div>
	...
	<div class="container">
		<div class="wthree_footer_grid_left">
			<div class="col-md-3 col-xs-3 wthree_footer_grid_left1">
				<h4>About Us</h4>
				<p>The North Face Public School is Complete School.</p>
			</div>
			<div class="col-md-3 col-xs-3 wthree_footer_grid_left1">
				<h4>Navigation</h4>
				<ul>
					...
					<li><i class="fa fa-angle-double-right" aria-hidden="true"></i><a href="#team" class="scroll">Teacher</a></li>
			...
			<div class="col-md-3 col-xs-3 wthree_footer_grid_left1 w3l-3">
				...
				<ul>
					...
					<li><i class="fa fa-angle-double-right" aria-hidden="true"></i><a href="#">Computer</a></li>
			...
			<div class="col-md-3 col-xs-3 wthree_footer_grid_left1 wthree_footer_grid_right1">
				<h4>Contact Us</h4>
				<ul>
					<li><i class="fa fa-envelope-o" aria-hidden="true"></i><a href="mailto:thenorthfacepublicschool@gmail.com">thenorthfacepublicschool@gmail.com</a></li>
					<li><i class="fa fa-phone" aria-hidden="true"></i>+91 943 140 9346</li>
					<li><i class="fa fa-fax" aria-hidden="true"></i>+00 00 000</li>
				</ul>
			</div>
			<div class="clearfix"> </div>
		</div>
...
<div class="w3layouts_copy_right">
	<div class="container">
		<p>© 2020 The North Face Public School. All rights reserved | Design by <a href="#">Mayank.</a></p>
	</div>
